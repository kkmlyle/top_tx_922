...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln24_fu_72_p2 == 1'd0)) begin
            i_fu_32 <= add_ln24_fu_78_p2;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln24_fu_72_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln24_fu_72_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln24_fu_78_p2 = (ap_sig_allocacmp_i_11 + 10'd1);
...
assign icmp_ln24_fu_72_p2 = ((ap_sig_allocacmp_i_11 == 10'd600) ? 1'b1 : 1'b0);
