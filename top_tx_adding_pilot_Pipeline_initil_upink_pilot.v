...
wire   [63:0] zext_ln48_fu_138_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] i_8_cast9_fu_155_p1;
reg   [9:0] i_8_fu_42;
wire   [9:0] zext_ln46_cast_fu_104_p1;
wire   [9:0] add_ln46_fu_144_p2;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_i;
wire   [9:0] sub_ln48_fu_122_p2;
wire   [7:0] tmp_fu_128_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln46_fu_116_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_8_fu_42 <= add_ln46_fu_144_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            i_8_fu_42 <= zext_ln46_cast_fu_104_p1;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln46_fu_116_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_i = zext_ln46_cast_fu_104_p1;
    end else begin
        ap_sig_allocacmp_i = i_8_fu_42;
    end
end
...
assign add_ln46_fu_144_p2 = (ap_sig_allocacmp_i + 10'd4);
...
assign i_8_cast9_fu_155_p1 = i_reg_185;

assign icmp_ln46_fu_116_p2 = ((ap_sig_allocacmp_i < 10'd600) ? 1'b1 : 1'b0);

assign pilot_array_im_address0 = zext_ln48_fu_138_p1;

assign pilot_array_re_address0 = zext_ln48_fu_138_p1;

assign pilot_vle_M_imag_V_address0 = i_8_cast9_fu_155_p1;

assign pilot_vle_M_imag_V_d0 = {{pilot_array_im_q0}, {14'd0}};

assign pilot_vle_M_real_V_address0 = i_8_cast9_fu_155_p1;

assign pilot_vle_M_real_V_d0 = {{pilot_array_re_q0}, {14'd0}};

assign sub_ln48_fu_122_p2 = (ap_sig_allocacmp_i - zext_ln46_cast_fu_104_p1);

assign tmp_fu_128_p4 = {{sub_ln48_fu_122_p2[9:2]}};

assign zext_ln46_cast_fu_104_p1 = zext_ln46;

assign zext_ln48_fu_138_p1 = tmp_fu_128_p4;
